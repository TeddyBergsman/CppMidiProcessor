...
static void testLookaheadPlannerJsonDeterminism() {
    ...
    in.debugEnergy = 0.25;
    in.weightsV2.density = 0.35;
    in.weightsV2.rhythm = 0.25;
    in.weightsV2.intensity = 0.45;
    in.weightsV2.dynamism = 0.40;
    in.weightsV2.emotion = 0.35;
    in.weightsV2.creativity = 0.25;
    in.weightsV2.tension = 0.45;
    in.weightsV2.interactivity = 0.55;
    in.weightsV2.variability = 0.35;
    in.weightsV2.warmth = 0.60;
    in.weightsV2.clamp01();
    in.hasNegotiatorState = false;
    in.engineNowMs = 123;
    in.nowMs = 1234567890;
        ...
        const QByteArray js = QByteArray(R"JSON(
{
  ...
  "drums": []
    ...
    c.energy = 0.55;
    c.weights.warmth = 0.35;
    c.weights.rhythm = 0.35;
    c.weights.interactivity = 0.35;
    c.weights.creativity = 0.35;
    c.weights.density = 0.35;
    c.weights.intensity = 0.45;
    c.weights.dynamism = 0.45;
    c.weights.emotion = 0.35;
    c.weights.tension = 0.45;
    c.weights.variability = 0.35;
    c.weights.clamp01();
    c.phraseBars = 4;
    c.barInPhrase = 1;
